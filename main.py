...
7) Convert all numbers from 1 to 100 into words, and use numerals for numbers beyond 100. Write years and dates as numerals in 'dd month yyyy' format. Use no apostrophe for decades like '1990s'. For abbreviated decades, use a single close quote as in '90s'.
